...
#define PURPLED_VERSION_MINOR	5
#define PURPLED_VERSION_PATCH	0
#define PURPLED_VERSION_EXTEN	""
...
typedef gboolean (*command_cb) (client *ptr, char *mesg, char **args, gpointer
				user_data);
